...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "RapidMusicVaves"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://i.ibb.co/34d3C61/images-4.jpg"
        ...
        [
            [
                InlineKeyboardButton("📚 Bilgi", url=f"https://t.me/RapidMusicBot"),
                InlineKeyboardButton(" Kanal", url=f"https://t.me/RapidDestek"),
            ],[
